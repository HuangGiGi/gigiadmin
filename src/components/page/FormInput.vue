		...
		<el-row :gutter="20">
			...
			<el-col :xs="24" :sm="24" :md="12" :lg="12">
				<el-card class="box-card">
					Time PICKER
                	<hr>
                	<el-time-select v-model="time1" style="width: 100%;" :picker-options="{start: '08:30',step: '00:15',end: '18:30'}" placeholder="选择时间"></el-time-select>
                	<br>
                	<br>
                	<el-time-select placeholder="起始时间" style="width: 49%;" v-model="startTime" :picker-options="{start: '08:30', step: '00:15', end: '18:30'}"></el-time-select>
                	<el-time-select placeholder="结束时间" v-model="endTime" style="width: 49%;" :picker-options="{start: '08:30', step: '00:15', end: '18:30',minTime: startTime}"></el-time-select>
                	<br>
                	<br>
				</el-card>
			</el-col>
